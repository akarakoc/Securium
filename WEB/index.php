            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Scanned URLs</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                  <div class="mytable">
					  ...
					  <tr>
						...
						<th>Scan Date</th>
						  ...
						  <?php
								$db = new SQLite3('C:/Users/ALI/eclipse-java-workspace/Selenium/test.db');
								$res = $db->query('SELECT * FROM urlList  ORDER BY scanDate DESC');
								while ($row = $res->fetchArray()) {
									echo "<tr><td>{$row['baseURL']}</td><td>{$row['fullURL']}</td><td> ".date('m/d/Y H:i:s', $row['scanDate']/1000)."<td></tr>";
								}
							?>
					  </table>
                  </div>
